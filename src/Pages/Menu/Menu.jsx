...
import menuImg from "../../../src/assets/menu/salad-bg.jpg"
...
return (
        <div className='mb-8 bg-stone-800'>
              <Helmet>
        <title>Besto Boss | Menu</title>
      </Helmet>
     <div > <Cover  img={menuImg} title="our menu"></Cover></div>
         {/* main cover */}
           <SectionTitle
